...
extension Restaurant {
    static let example = Restaurant(id: UUID().uuidString, yelpId: "h2eeVnhUL8zEbTnUrjJomw", name: "Restaurant Hirschli", geoPoint: GeoHashCoordinate(latitude: 47.4742813, longitude: 8.3077803), isActive: true)
